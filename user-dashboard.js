...
// Face detection and mask detection models (simulated)
...
function checkAuthentication() {
    ...
    document.getElementById('userRole').textContent = currentUser.role === 'user' ? 'Employee' : 'Student';
}
...
function checkTodayAttendance() {
    ...
    if (lastAttendance) {
        ...
        showNotification('info', 'Attendance Status', 'You have already marked your attendance today.');
    }
}
